...
function DecisionTreeModel(props) {
    ...
    const [criterion, setCriterion] = React.useState("gini");
    ...
    function onCriterionChanged(event) {
    ...
    function onSubmitted() {
        const args = {
            "algorithm_name": "decision_tree_classification",
            "hyperparameters": {
                "test-size": testSize,
    ...
    return (
        <React.Fragment>
            ...
            <SmallDescription>
                This value measures the quality of a split
            </SmallDescription>
            <Select
                id="criterion"
                value={criterion}
                onChange={onCriterionChanged}>
